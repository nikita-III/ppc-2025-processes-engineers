...
## 2. Постановка задачи
На вход программы подаются две строки. Необходимо определить лексикографическую упорядоченность каждой из них в отдельности.
...
## 8. Заключение
В результате применения технологии MPI программа ускорилась.
